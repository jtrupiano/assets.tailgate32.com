$().ready(function() {
  ...
  $('#tshirt-options').change(function() {
    $('#tshirt-front').attr("src", "http://assets.tailgate32.com/images/tshirts/" + $(this).val() + "-front.png");
    $('#tshirt-back').attr("src", "http://assets.tailgate32.com/images/tshirts/" + $(this).val() + "-back.png");
  });
});
